...
Psat, yji, ki, Zj, fj = Psat_newton(T, yi, Pci, Tci, wi, mwi, dij, vsi)
# c,upper, Pmin, Pmax, N_nodes, eps1, eps2, maxiter, level, pure_ind, pure_eps, eps_newton, maxiter_newton)
...
for p in P:
  ...
  yji, fj, Zj = equil_max2p_newton(p, T, yi, Pci, Tci, wi, dij, vsi, mwi)

                                   # negative_flash, maxiter_flash, eps_flash, method_stab,  eps1_stab, eps2_stab, maxiter_stab, level, pure_ind, pure_eps,
                                   # eps_rr, maxiter_rr)
  nj = fj * nt
  vj = Zj * R * T / p
